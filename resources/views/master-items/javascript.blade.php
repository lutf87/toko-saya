...
<script src="{{ asset('AdminLTE-3.2.0/docs/assets/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<!-- ChartJS -->
...
<script src="{{ asset('AdminLTE-3.2.0/docs/assets/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js') }}"></script>
<!-- AdminLTE App -->
